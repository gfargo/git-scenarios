...
Named, curated repo states. Call `spinUpScenario('mid-merge-conflict')` and you get a real temp git repo in that state. 46 built-in scenarios cover branches, conflicts, stash, worktrees, submodules, monorepos, orphan branches, and more.
